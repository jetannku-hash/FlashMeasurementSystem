...
| 順序 | 編號 | 項目 | 工時 | 風險 | 類型 |
|------|------|------|------|------|------|
| 1 | N3 | 空狀態工作流引導 | ~1hr | 低 | 新增 |
| 2 | N2 | 大字 PASS/FAIL 橫幅 | ~1hr | 低 | 新增 |
| 3 | N5 | 編輯器即時顯示公差上下限 | ~30分 | 低 | 新增 |
| 4 | N1 | 配方驗證（Pre-run diagnostic） | ~3-4hr | 低-中 | 新增 |
| 5 | A1 | 編輯器內試測 | ~1-2hr | 中 | 改善 |
| 6 | N6 | 量測快捷鍵 + 拖放影像 | ~30分 | 低 | 新增 |
| 7 | A3 | 即時邊緣預覽 | ~1-2hr | 低-中 | 改善 |
| 8 | A5 | Undo/Redo | ~2-3hr | 中 | 改善 |
| 9 | N7 | 最近開啟的配方/影像 | ~1-2hr | 低 | 新增 |
| 10 | A4 | 工具列表 TreeView | ~2-3hr | 中 | 改善（選配） |
