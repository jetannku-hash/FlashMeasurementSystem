...
namespace FlashMeasurementSystem.Tests
{
    public static class EdgeDetectionDomainTests
    {
        public static int Main()
        {
            ...
            StraightnessBandDomainTests.Run();
            EdgeParametersFuzzyDomainTests.Run();
            ...
            MetrologyJudgerTests.Run();
            Console.WriteLine("MetrologyJudgerTests passed");
            ...
            ReportRetentionDomainTests.Run();
            Console.WriteLine("ReportRetentionDomainTests passed");
            PdfReportWriterTests.Run();   // Run() 內部自行印出 "PdfReportWriterTests passed"
